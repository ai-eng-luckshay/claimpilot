...
def _fetch_member_claims_context(member_id: str) -> list[dict]:
    """
    TODO: fetch recent claims for this member to pass as context to adjudication.
    Currently returns empty list — wire up to claim_repository once available.
    """
    return []
