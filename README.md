...
├── scripts/
│   ├── run_eval.py                     # eval runner: hits API for all 12 TCs → eval_report.md
...
│   ├── assumptions.md
│   ├── failure_handling.md
│   └── eval_report.md                  # generated by scripts/run_eval.py
├── .env.example
└── render.yaml
```
...
```bash
# Run all 12 test cases against the deployed Render API → writes docs/eval_report.md
